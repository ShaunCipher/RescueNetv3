...
class TopNavigation(ctk.CTkFrame):
    def __init__(self, master, toggle_left_cmd, toggle_right_cmd, command_center=None, **kwargs):
        ...
        if self.cmd_center:
            ...
            report_manager = getattr(self.cmd_center, "report_manager", None)
            if report_manager and hasattr(report_manager, "open_report_window"):
                self.report_btn = ctk.CTkButton(
                    ...
                    fg_color="#c0392b",
                    hover_color="#e74c3c",
                    command=report_manager.open_report_window,
                )
